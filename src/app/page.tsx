    ...
    <AppLayout>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {/* Upload Scans */}
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-slate-200 hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
            <div className="text-5xl mb-6 text-center">�</div>
            <h3 className="text-2xl font-bold text-slate-900 mb-4 text-center">Quick Scan Upload</h3>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-slate-200 hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
            <div className="text-5xl mb-6 text-center">�</div>
            <h3 className="text-2xl font-bold text-slate-900 mb-4 text-center">View Reports</h3>
            <p className="text-slate-600 mb-8 text-center leading-relaxed">
          ...
          {/* Risk Analytics */}
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-slate-200 hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] md:col-span-2 lg:col-span-1">
            <div className="text-5xl mb-6 text-center">�</div>
            <h3 className="text-2xl font-bold text-slate-900 mb-4 text-center">Risk Analytics</h3>
            <p className="text-slate-600 mb-8 text-center leading-relaxed">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8 lg:p-12 mb-16">
          <div className="text-center mb-10">
            <div className="text-6xl mb-6">📑</div>
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Professional VA Reports</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-center">
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-slate-900">Report Sections</h3>
              <div className="space-y-2 text-slate-600">
                ...
                <div className="flex items-center justify-center space-x-2">
                  <span className="text-green-500">✅</span>
                  <span>Scan Manifest & Methodology</span>
                </div>
                <div className="flex items-center justify-center space-x-2">
                  <span className="text-green-500">✅</span>
                  <span>Project Scope & Host Summary</span>
                </div>
                <div className="flex items-center justify-center space-x-2">
                  <span className="text-green-500">✅</span>
                  <span>Risk-Level & Zero-Day Analysis</span>
                </div>
                <div className="flex items-center justify-center space-x-2">
                  <span className="text-green-500">✅</span>
                  <span>Detailed Vulnerabilities & Conclusion</span>
                </div>
              </div>
            </div>
