        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-base text-gray-600 max-w-2xl mx-auto">
              Search for organizations to view their vulnerability assessment
              reports.
            </p>
          </div>
          ...
          <div className="professional-card mb-8">
            ...
            {showFilters && filters.search.trim() && (
          ...
          {!filters.search.trim() ? (
            ...
            <div className="professional-card text-center py-16">
              ...
              <p className="text-gray-600 mb-8 max-w-md mx-auto">
                Enter an organization name, assessee, or assessor in the search
                box above to find vulnerability assessment reports.
              </p>
